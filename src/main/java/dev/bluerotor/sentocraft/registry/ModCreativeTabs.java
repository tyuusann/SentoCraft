...
public class ModCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SENTOCRAFT_TAB =
            CREATIVE_MODE_TABS.register("sentocraft", () -> CreativeModeTab.builder()
                    .title(Component.literal("SentoCraft"))
                    .icon(() -> new ItemStack(ModItems.TANK.get()))
